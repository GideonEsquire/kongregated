...
function reddit_list(news) {
    ...
    $.each(news, function (index, obj) {
        ...
        l.append($("<li></li>")
            ...
            .append("<a target = '_blank' href = " + link + "><text class = 're-title'>" + obj.title + "</text><a/>  <a target = '_blank' style = 'color:grey;outline:0' href=http://www." + obj.domain + '>(' + obj.domain + ')</a>')).append($("<p class='re-under'><a target = '_blank' href = " + 'http://reddit.com' + obj.permalink + " style = 'outline:0'><font color='grey'><b>(score: " + obj.score + ' | comments: ' + obj.num_comments + ') on reddit.com</b></font></a><p>'))
